...
//             <input type="text" className="form-control" placeholder="예) 에코델타호반써밋스마트시티" />
//           </div>
//         </div>
//         <div className="col-sm-6 col-xl-4">
//           <div className="mb30">
//             <label className="heading-color ff-heading fw600 mb10">동 입력</label>
//             <input type="text" className="form-control" placeholder="예) 101동" />
//           </div>
//         </div>
//         <div className="col-sm-6 col-xl-4">
//           <div className="mb30">
//             <label className="heading-color ff-heading fw600 mb10">호 입력</label>
//             <input type="text" className="form-control" placeholder="예) 301호" />
//           </div>
//         </div>
//         {/* End .col-6 */}
//         <div className="col-sm-6 col-xl-4">
//           <div className="mb30">
//             <label className="heading-color ff-heading fw600 mb10">매물 크기</label>
//             <input type="text" className="form-control" placeholder="평 수 입력" />
//           </div>
//         </div>
//         <div className="col-sm-6 col-xl-4">
//           <div className="mb30">
//             <label className="heading-color ff-heading fw600 mb10">방향</label>
//             <input type="text" className="form-control" placeholder="ex)남향" />
//           </div>
//         </div>
