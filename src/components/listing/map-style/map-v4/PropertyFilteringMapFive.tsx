...
//     handlepropertyTypes: (elm: string) => setPropertyTypes(prev => prev.includes(elm) ? prev.filter((el) => el !== elm) : [...prev, elm]),
...
//     handlecategories: (elm: string) => setCategories(prev => prev.includes(elm) ? prev.filter((el) => el !== elm) : [...prev, elm]),
//     priceRange,
//     listingStatus,
//     propertyTypes,
//     resetFilter,
...
//     // filteredArrays.push(refItems.filter((el) => el.town.toLowerCase().includes(searchQuery.toLowerCase()) ||
//     //   el.roadAddress.toLowerCase().includes(searchQuery.toLowerCase()) ||
//     //   el.atclNm.toLowerCase().includes(searchQuery.toLowerCase()) ||
//     //   el.atclFetrDesc.toLowerCase().includes(searchQuery.toLowerCase())));
//     // filteredArrays.push(!categories.length ? [...refItems] : refItems.filter((elm) => categories.every((elem) => elm.tagList.includes(elem))));
//     // if (location !== 'All Cities') {
//     //   filteredArrays.push(refItems.filter((el) => el.town === location));
//     // }
//     // if (priceRange.length > 0) {
//     //   filteredArrays.push(refItems.filter(
//     //     (elm) =>
//     //       elm.prc >= priceRange[0] &&
//     //       elm.prc <= priceRange[1],
//     //   ));
//     // }
//     // if (squirefeet.length > 0 && squirefeet[1]) {
//     //   filteredArrays.push(refItems.filter(
//     //     (elm) => elm.spc1 >= squirefeet[0] && elm.spc1 <= squirefeet[1],
//     //   ));
//     // }
//     // if (yearBuild.length > 0) {
//     //   filteredArrays.push(refItems.filter(
//     //     (elm) => parseInt(elm.atclCfmYmd.substring(0, 4)) >= yearBuild[0] && parseInt(elm.atclCfmYmd.substring(0, 4)) <= yearBuild[1],
//     //   ));
//     // }
